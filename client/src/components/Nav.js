    ...
    <div id='main' className='w-full'>
        <div className='right-0 left-60 flex justify-between items-center justify-center pt-4 pb-2'>
          ...
          <div className='px-4 flex'>
              ...
              <button onClick={onLogout} className='pt-1 pb-2 px-3 w-24 duration-300 text-sm rounded-full text-white bg-black hover:bg-white hover:text-slate-700 underline'>Log out!</button>
          </div>
        </div>
    </div>
    </>
